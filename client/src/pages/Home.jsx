...
import { Search, ArrowRight, Shield, Clock, Star, CheckCircle, ChevronRight, Truck, Car, Tractor } from 'lucide-react';
...
const HOW_IT_WORKS = [
  { step: '01', title: 'Browse & Discover', desc: 'Explore our curated fleet of premium vehicles available in your area.', icon: Search },
  { step: '02', title: 'Book or Request', desc: "Book an available vehicle or submit a request if you don't find what you need.", icon: CheckCircle },
  { step: '03', title: 'Admin Approval', desc: 'Our team reviews and approves your booking ensuring quality and safety.', icon: Shield },
  { step: '04', title: 'Pick Up & Go', desc: 'Collect your vehicle at the agreed location and start your journey.', icon: ArrowRight },
];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 text-center">
          <div className="animate-slide-up">
            ...
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              Your Trusted{' '}
              <span className="gradient-text text-shadow-gold">Vehicle Partner</span>
              <br />For Every Journey
            </h1>

            <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
              Connect with verified vehicle owners. Rent trucks, tractors, cars, cranes, and more.
              Every booking managed securely by our expert team.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-6">
              {['Trucks', 'Tractors', 'Cranes', 'Buses', 'Excavators'].map(type => (
                <Link
                  key={type}
                  to={`/browse?type=${type.toLowerCase()}`}
          ...
          <div className="hidden lg:block">
            <div className="absolute top-1/3 left-8 text-6xl animate-float opacity-20" style={{ animationDelay: '0s' }}>🚛</div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-title mb-3">Vehicle Categories</h2>
            <div className="divider mx-auto mb-4" />
            <p className="text-slate-400 max-w-xl mx-auto">From heavy-duty trucks to precision machinery, find exactly what your project demands.</p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {VEHICLE_CATEGORIES.map((cat) => (
              ...
              >
                <div className="text-4xl mb-3 group-hover:scale-110 transition-transform duration-300 animate-float" style={{ animationDelay: `${Math.random()}s` }}>
                  {cat.emoji}
                </div>
      ...
      <section className="py-20 bg-slate-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-12">
            <div>
              <h2 className="section-title mb-3">Featured Vehicles</h2>
              <div className="divider mb-4" />
              <p className="text-slate-400">Top-rated vehicles available for immediate booking.</p>
            </div>
          ...
          {loadingFeatured ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-slate-400">No vehicles listed yet. Be the first to add one!</p>
              <Link to="/register" className="btn-primary inline-flex mt-4">List Your Vehicle</Link>
            </div>
          )}
      ...
      <section id="how-it-works" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="section-title mb-3">How CarPartner Works</h2>
            <div className="divider mx-auto mb-4" />
            <p className="text-slate-400 max-w-xl mx-auto">Simple, secure, and seamless — from browse to booking in minutes.</p>
          </div>
            ...
            <div className="relative z-10 p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8">
              <div>
                ...
                <p className="text-slate-300 max-w-lg leading-relaxed">
                  Join thousands of vehicle owners and renters on CarPartner. List your vehicle today
                  or find the perfect rental for your next project.
                </p>
              </div>
              <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0">
                <Link to="/browse" className="btn-primary flex items-center gap-2 whitespace-nowrap">
                  Find a Vehicle <ArrowRight size={16} />
                </Link>
